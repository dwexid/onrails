...
class MahasiswasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mahasiswa" do
    assert_difference('Mahasiswa.count') do
      post mahasiswas_url, params: { mahasiswa: { alamat: @mahasiswa.alamat, angkatan: @mahasiswa.angkatan, jurusan: @mahasiswa.jurusan, nama: @mahasiswa.nama, nim: @mahasiswa.nim } }
    end
  ...
  test "should update mahasiswa" do
    patch mahasiswa_url(@mahasiswa), params: { mahasiswa: { alamat: @mahasiswa.alamat, angkatan: @mahasiswa.angkatan, jurusan: @mahasiswa.jurusan, nama: @mahasiswa.nama, nim: @mahasiswa.nim } }
