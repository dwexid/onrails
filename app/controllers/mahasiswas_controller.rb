class MahasiswasController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @mahasiswa.save
        format.html { redirect_to @mahasiswa, notice: '! Data berhasil ditambahkan.' }
  ...
  def update
    respond_to do |format|
      if @mahasiswa.update(mahasiswa_params)
        format.html { redirect_to @mahasiswa, notice: '! Data berhasil diupdate.' }
  ...
  def destroy
    @mahasiswa.destroy
    respond_to do |format|
      format.html { redirect_to mahasiswas_url, notice: '! Data berhasil dihapus.' }
  ...
  private
    ...
    def mahasiswa_params
      params.require(:mahasiswa).permit(:nim, :nama, :alamat, :jurusan, :angkatan)
    end
end
